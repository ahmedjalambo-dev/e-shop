...
class _CartService implements CartService {
  ...
  Future<AddItemToCartResponse> addItemToCart(
    ...
    final _options = _setStreamType<AddItemToCartResponse>(
    ...
    late AddItemToCartResponse _value;
    try {
      _value = AddItemToCartResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<UpdateItemResponse> updateCartItem(
    ...
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(updateItemRequestBody.toJson());
    final _options = _setStreamType<UpdateItemResponse>(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late UpdateItemResponse _value;
    try {
      _value = UpdateItemResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  @override
  Future<void> deleteCartItem(String itemId, DeleteItemRequestBody body) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
